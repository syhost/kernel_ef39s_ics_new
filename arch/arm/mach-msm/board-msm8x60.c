...
#else
#include <linux/clk.h> // N1037 20120217 not use DSPS 
#endif
...
#endif /*CONFIG_PANTECH_FB_MSM_MHL_SII9244*/
...
#if defined(CONFIG_SMB137B_CHARGER) || defined(CONFIG_SMB137B_CHARGER_MODULE)
	if (machine_is_msm8x60_fluid()
#ifdef CONFIG_SKY_SMB_CHARGER //N0056
...
#ifdef CONFIG_SKY_BATTERY_MAX17040 //p14682 kobj 110607ps2 team shs : fuel gauge porting // jcpark
...
#ifdef CONFIG_F_SKYDISP_PMEM_OPTIMIZE
...
#define MSM_FB_EXT_BUF_SIZE  \
		(roundup((1920 * 1088 * 4), 4096) * 2) /* 2 bpp x 1 page */
#else
#define MSM_FB_EXT_BUF_SIZE  \
...
#define MSM_SMI_SIZE          0x4000000 /* 100 Mbytes = 0x6400000*//* 64 Mbytes = 0x4000000 */
...
#define MSM_ION_SF_SIZE		0x3200000 /*90Mbytes = 0x5A00000*//*84Mbytes = 0x5400000*//*90Mbytes = 0x5A00000*//* 80 Mbytes = 0x5000000 */ /* 64MB = 0x4000000 */
#define MSM_ION_CAMERA_SIZE     0x3200000 //F_PANTECH_CAMERA  MSM_PMEM_ADSP_SIZE
#define MSM_ION_MM_FW_SIZE	0x200000 /* (2MB) */
#define MSM_ION_MM_SIZE		0x3200000 /*90Mbytes = 0x5A00000*//*84Mbytes = 0x5400000*//*90Mbytes = 0x5A00000*//*84Mbytes = 0x5400000*//* (54MB) =0x3600000*/
#define MSM_ION_MFC_SIZE	SZ_8K
//----#ifdef CONFIG_FB_MSM_OVERLAY1_WRITEBACK
//----#define MSM_ION_WB_SIZE		0xC00000 /* 12MB */
//----#else
#define MSM_ION_WB_SIZE		0x700000 /* 7MB */ //0x600000 /* 6MB */
//----#endif
...
#ifdef CONFIG_TOUCHSCREEN_CY8C_TS		// N1037 20120329 for EF39S 
...
//E 20110908 ssoh Change_AVdd_3.3V	
	...
	RPM_LDO(PM8058_L3,  0, 1, 0, 2800000, 2800000, LDO150HMIN),
#else
...
#if defined(CONFIG_INPUT_PANTECH_EARJACK) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40K) ||defined(CONFIG_MACH_MSM8X60_EF40S)) // N1037 20120330 for ICS EarJack 
	...
	RPM_LDO(PM8058_L11, 0, 1, 0, 2600000, 2600000, LDO150HMIN),
#else
...
// 201110422, kkcho,  for MHL-power
...
#if defined(CONFIG_PANTECH_CAMERA) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40S) ||defined(CONFIG_MACH_MSM8X60_EF40K))
	RPM_LDO(PM8058_L14, 0, 1, 0, 2800000, 2800000, LDO300HMIN),
#else // for SD card
	RPM_LDO(PM8058_L14, 0, 0, 0, 2850000, 2850000, LDO300HMIN),
#endif
#if defined(CONFIG_PANTECH_CAMERA) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40S) ||defined(CONFIG_MACH_MSM8X60_EF40K))
#ifdef CONFIG_SKY_MMC /*for EF39S, EF40S, EF40K*/
	RPM_LDO(PM8058_L15, 0, 1, 0, 2850000, 3000000, LDO300HMIN),
#else
  ...
  #if defined(CONFIG_PANTECH_CAMERA) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40S) ||defined(CONFIG_MACH_MSM8X60_EF40K))
	RPM_LDO(PM8058_L19, 0, 1, 0, 2800000, 2800000, LDO150HMIN),
    #else
	...
	RPM_LDO(PM8058_L24, 0, 1, 0, 1800000, 1800000, LDO150HMIN),
#else
...
#if defined(CONFIG_TOUCHSCREEN_QT602240) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40K) ||defined(CONFIG_MACH_MSM8X60_EF40S)) // N1037 20120329 for ICS touch 
	...
	RPM_VS(PM8901_LVS1, 0, 1, 1800000),
#else
	RPM_VS(PM8901_LVS1, 0, 1, 0),
#endif
#if (defined(CONFIG_PANTECH_CAMERA) && defined(CONFIG_MACH_MSM8X60_PRESTO)) || (defined(CONFIG_TOUCHSCREEN_QT602240) && ((defined(CONFIG_MACH_MSM8X60_EF40K)||defined(CONFIG_MACH_MSM8X60_EF40S)) && (BOARD_REV >= WS20))) // N1037 20120329 for ICS Touch 
	RPM_VS(PM8901_LVS2, 0, 1, 1800000),	
#else	
	RPM_VS(PM8901_LVS2, 0, 1, 0),	
#endif	
	RPM_VS(PM8901_LVS3, 0, 1, 0),
#if defined(CONFIG_PANTECH_CAMERA) && (defined(CONFIG_MACH_MSM8X60_EF39S) ||defined(CONFIG_MACH_MSM8X60_EF40S) ||defined(CONFIG_MACH_MSM8X60_EF40K)) || defined(CONFIG_MACH_MSM8X60_PRESTO)
	RPM_VS(PM8901_MVS0, 0, 1, 1800000),
#else
...
{
//20110323 choiseulkee chg for EF39S bring-up //N0056
...
#if defined(CONFIG_SKY_EF39S_BOARD) || defined(CONFIG_SKY_EF40K_BOARD) || defined(CONFIG_SKY_EF40S_BOARD) //N0056
...
static int bluetooth_power(int on)
{
	...
	if (on)
	{
		...
		msleep(100);
		gpio_set_value(158, 1); /* BT_SYSRST */
		gpio_set_value(101, 1); /* BT_REG_ON */
		msleep(100);
	}
	else
	{
